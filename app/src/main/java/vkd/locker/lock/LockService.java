...
import vkd.locker.lock.PasswordView.OnNumberListener;
import vkd.locker.lock.PatternView.DisplayMode;
import vkd.locker.lock.PatternView.OnPatternListener;
...
public class LockService extends Service implements View.OnClickListener, View.OnKeyListener {
    ...
    Bitmap decodeSampledBitmapFromUri(Uri uri, int reqWidth, int reqHeight) throws FileNotFoundException {
